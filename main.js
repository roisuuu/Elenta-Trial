...
miro.onReady(() => {
  miro.initialize({
    extensionPoints: {
      ...
      onClick: () => {
        miro.showNotification("Bottom bar item goes clicky click")
        alert("hi kenneth")
      },
    },
    toolbar: {
      ...
      onClick: () => {
        alert('yeet!')
        miro.showErrorNotification("uhhhhhh")
      },
    },
    },
  })
